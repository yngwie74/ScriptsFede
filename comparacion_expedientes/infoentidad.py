...
class OkwQueries:
    ...
    K_MEDIDOR_RESULTADO = 'select * from OKW.K_MEDIDOR_RESULTADO where FL_PACIENTE = {0} order by FL_MEDIDOR_RESULTADO'
...
INFO_ENTIDADES = {
    'OKW' : (
        EntidadInfo(OKW.C_PACIENTE, OkwQueries.C_PACIENTE, keys=['FL_PACIENTE'], ignored_cols=['FE_SYNC_EXPEDIENTE', 'FE_RECEP_EXPEDIENTE', 'DS_UNIDADES_EXPEDIENTE']),
        ...
        EntidadInfo(OKW.K_DETALLE_EXPEDIENTE_HIST, OkwQueries.K_DETALLE_EXPEDIENTE_HIST, keys=('FL_DETALLE_EXPEDIENTE_HIST')),
        ...
        EntidadInfo(OKW.K_MEDICAMENTO_FC, OkwQueries.K_MEDICAMENTO_FC, keys=['FL_MEDICAMENTO_FC']),
        ...
        EntidadInfo(OKW.K_MEDIDOR_RESULTADO, OkwQueries.K_MEDIDOR_RESULTADO, keys=['FL_MEDIDOR_RESULTADO']),
    ),
    'SOMATOM' : (
