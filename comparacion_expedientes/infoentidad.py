...
class OkwQueries:
    ...
    K_BITACORA_DIAGNOSTICO = 'select * from OKW.K_BITACORA_DIAGNOSTICO where FL_DIAGNOSTICO_PACIENTE in (select distinct FL_DIAGNOSTICO_PACIENTE from OKW.K_DIAGNOSTICO_PACIENTE where FL_PACIENTE = {0}) order by FL_BITACORA'
    K_DETALLE_EXPEDIENTE = 'select * from OKW.K_DETALLE_EXPEDIENTE where FL_PACIENTE = {0} order by FL_DETALLE_EXPEDIENTE'
    K_DETALLE_EXPEDIENTE_HIST = 'select * from OKW.K_DETALLE_EXPEDIENTE_HIST where FL_DETALLE_EXPEDIENTE in (select distinct FL_DETALLE_EXPEDIENTE from OKW.K_DETALLE_EXPEDIENTE where FL_PACIENTE = {0}) order by FL_DETALLE_EXPEDIENTE ,FE_CAMBIO'
    K_PRESCRIPCION = 'select * from OKW.K_PRESCRIPCION where FL_PACIENTE = {0} order by FL_PRESCRIPCION'
    #~K_ESTUDIO_CLINICO_PRESCRIPCION = 'select * from OKW.K_ESTUDIO_CLINICO_PRESCRIPCION where FL_PRESCRIPCION in (select distinct FL_PRESCRIPCION from OKW.K_PRESCRIPCION where FL_PACIENTE = {0}) order by FL_PRESCRIPCION ,FL_PAQUETE_ESTUDIOS ,FL_ESTUDIO_CLINICO ,FL_ESTUDIO_CLINICO_PRESCRIPCION'
    K_ESTUDIO_CLINICO_PRESCRIPCION = 'select * from OKW.K_ESTUDIO_CLINICO_PRESCRIPCION where FL_PRESCRIPCION in (select distinct FL_PRESCRIPCION from OKW.K_PRESCRIPCION where FL_PACIENTE = {0}) order by FL_PRESCRIPCION ,FL_PAQUETE_ESTUDIOS ,FL_ESTUDIO_CLINICO'
    K_ESTUDIO_CLINICO_RESULTADO = 'select * from OKW.K_ESTUDIO_CLINICO_RESULTADO where FL_PRESCRIPCION in (select distinct FL_PRESCRIPCION from OKW.K_PRESCRIPCION where FL_PACIENTE = {0}) order by FL_PRESCRIPCION ,FL_ESTUDIO_CLINICO_RESULTADO'
    K_RESULTADO_ESTUDIO = 'select * from OKW.K_RESULTADO_ESTUDIO where FL_ESTUDIO_CLINICO_RESULTADO in (select distinct FL_ESTUDIO_CLINICO_RESULTADO from OKW.K_ESTUDIO_CLINICO_RESULTADO where FL_PRESCRIPCION in (select distinct FL_PRESCRIPCION from OKW.K_PRESCRIPCION where FL_PACIENTE = {0})) order by FL_ESTUDIO_CLINICO_RESULTADO ,FL_RESULTADO_ESTUDIO'
    ...
    K_MEDICAMENTO_FC = 'select * from OKW.K_MEDICAMENTO_FC where FL_MEDICACION in (select distinct FL_MEDICACION from OKW.K_MEDICACION where FL_PACIENTE = {0}) order by FL_MEDICACION'
...
INFO_ENTIDADES = {
    'OKW' : (
        ...
        EntidadInfo(OKW.K_DETALLE_EXPEDIENTE, OkwQueries.K_DETALLE_EXPEDIENTE, keys=['FL_DETALLE_EXPEDIENTE'], ignored_cols=['FL_PACIENTE_CITA']),
